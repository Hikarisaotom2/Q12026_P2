...
public class Clase_16022026 {
    ...
    public static void main(String[] args) {
        ...
        2) clases abstractas .
        los metodos abstractos carecen de cuerpo, son imcpmpletos, solamente puede existir dentro de interfaces y clases abstractas 
        las clases abstractas NO PUEDEN INSTANCIARSE
        
        -> Es mucho mas seguro,
        ->por que obliga a los hijos a crear su propio metodo polimorfico.
